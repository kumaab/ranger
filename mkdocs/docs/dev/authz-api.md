...
!!! note "Two integration styles in the code base"
    ...
    Plugin architecture and Custom plugins.
...
# ranger.authz.service.dev_hive.policy.rest.client.jwt.supplier=<class implementing java.util.function.Supplier<String>>
