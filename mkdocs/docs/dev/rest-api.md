...
(see [Admin authentication](../services/admin/authentication.md)).
...
| Method | Path | Description |
| --- | --- | --- |
| `GET` | `/metrics/status` | Admin status. `/metrics/**` requires no authentication; see [Metrics](../services/admin/metrics.md). |
