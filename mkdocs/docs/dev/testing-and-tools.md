...
| `dev-support/ranger-docker/` | Docker Compose stack; see [Running Ranger with Docker](../getting-started/docker.md). |
...
- [Plugin architecture](../arch/plugin-architecture.md) — what the policy engine tests exercise.
