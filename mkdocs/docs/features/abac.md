...
source, the distinguished name and the original (pre-transformation) name. See
[LDAP and AD sources](../services/usersync/ldap-ad.md) for the rest of the UserSync configuration.
...
- [LDAP and AD sources](../services/usersync/ldap-ad.md) — syncing additional attributes.
