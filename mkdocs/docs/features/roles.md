...
UNIX or LDAP, and they can be nested. They were introduced in Ranger 2.0.0 ([RANGER-2414](https://issues.apache.org/jira/browse/RANGER-2414)) together with
support for Hive SQL role statements ([RANGER-2425](https://issues.apache.org/jira/browse/RANGER-2425)).
