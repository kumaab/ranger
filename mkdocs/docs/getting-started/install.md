...
To build Ranger yourself and to learn which archives the build produces, see
[Building from source](../dev/build.md). Released source and binary archives are listed on the
...
Admin to anyone else. See [Users, groups and roles](../services/admin/users-groups-roles.md).
