...
- [Audit Server](../audit-server/service.md) — the centralized Kafka-based pipeline.
...
- [Plugin architecture](../../arch/plugin-architecture.md) — where the audit handler sits in a plugin.
