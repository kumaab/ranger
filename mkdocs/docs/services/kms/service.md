...
- `ranger-kms-security.xml`, `ranger-kms-audit.xml` and the client TLS file named by
  `ranger.plugin.kms.policy.rest.ssl.config.file` - the Ranger KMS plugin; At minimum set `ranger.plugin.kms.policy.rest.url` (Ranger Admin URL)
