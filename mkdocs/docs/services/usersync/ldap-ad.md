...
UserStore can use them (see [ABAC](../../features/abac.md)).
...
- cwiki: [Multiple OU support](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=61335387),
  [Additional user/group attributes (RANGER-2697)](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=199531294),
